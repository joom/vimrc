...
call s:HL('jsBraces', 'orange')
call s:HL('jsFunction', 'aqua')
call s:HL('jsIdentifier', 'red')
call s:HL('jsMember', 'blue')
call s:HL('jsNumber', 'purple')
call s:HL('jsNull', 'purple')
call s:HL('jsParens', 'light3')
call s:HL('jsOperator', 'red')
call s:HL('jsObjectKey', 'blue')
...
" Haskell: {{{
call s:HL('hsOperator', 'aqua')
call s:HL('haskellOperator', 'aqua')
call s:HL('hsSpecialChar', 'blue')
